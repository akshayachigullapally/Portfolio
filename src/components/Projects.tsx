...
const personalProjects = [
	{
		title: "Habit Quest",
		description:
			"A gamified habit tracking application that helps users build and maintain positive habits through engaging challenges and progress tracking.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
	...
	},
	{
		...
		description:
			"An AI-powered career coaching platform that provides personalized guidance, interview preparation, and AI-powered tools for job success.",
	...
	},
	{
		title: "Imagify",
		description:
			"A text-to-image generator application that transforms text prompts into stunning visual art using advanced AI models.",
		technologies: [
			"React",
			"Node.js",
			"AI/ML",
	...
	},
	{
		...
		description:
			"A full-featured real-time messaging application with modern UI, user authentication, and instant message delivery.",
	...
	},
	{
		title: "Movie App",
		description:
			"A React Native mobile application for browsing movies, viewing details, and managing watchlists with intuitive user interface.",
	...
	},
	{
		...
		description:
			"A food donation and distribution platform designed to tackle food wastage and help feed those in need within communities.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
	...
	},
	{
		...
		description:
			"A modern blogging platform where users can create, publish, and share articles with a clean, responsive design.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
	...
	},
	{
		...
		description:
			"A comprehensive library management system for tracking books, managing borrowers, and automating library operations.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
	...
	},
	{
		...
		description:
			"A mental health and wellbeing application based on positive psychology principles to enhance overall life satisfaction.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
	...
	},
	{
		...
		description:
			"A full-featured e-commerce solution with product management, shopping cart, payment integration, and order tracking.",
		technologies: [
			"React",
			"Node.js",
			"MongoDB",
...
const academicProjects = [
	{
		title: "CSI Website",
		description:
			"Official website for Computer Society of India VNRVJIET chapter with event management, member registration, and college branding.",
	...
	},
	{
		...
		description:
			"A multi-reality hackathon platform for ideation, design, gaming, and expression events with modern UI and event management.",
